...
public class MapBasedTagGroup implements TagGroup {
    ...
    /**
     * @param tagMap map from keys to values; != null; must not be modified
     * after being used as parameter
     */
    ...
    /**
     * returns an Iterator providing access to all Tags. The Iterator does not
