...
public final class ValueStringParser {
    ...
    /**
     * parses a weight value given e.g. for the "maxweight" or "maxaxleload"
     * key.
     *
     ...
     *
     * @return angle in degrees measured from north, range [0, 360[; null if
     * value had syntax errors
     */
