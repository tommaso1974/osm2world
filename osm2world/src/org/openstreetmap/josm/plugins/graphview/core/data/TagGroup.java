...
/**
 * represents a group of OSM tags (e.g. all tags of a way). TagGroups are
 * expected to be immutable, so modifying the tags means creation of a new
 * group. This interface requires that keys are unique, which is guaranteed
 * since OSM API 0.6.
 */
public interface TagGroup extends Iterable<Tag> {

    /**
     * returns the value for the given key or null if no tag in this group uses
     * that key
     *
    ...
    /**
     * returns true if this tag group contains at least one tag with the given
     * value
     *
    ...
    /**
     * returns true if this tag group contains at least one tag with one of the
     * given values
     *
    ...
    /**
     * returns true if this tag group contains one of the keys with value
     *
    ...
    /**
     * returns true if this tag group contains one of the keys with one of the
     * values
     *
     * @param keys keys of the tag to check for; != null
    ...
    /**
     * returns true if this tag group contains the key with one of the values
     *
     * @param key key of the tag to check for; != null
     * @param values values of the tag to check for; != null
     */
