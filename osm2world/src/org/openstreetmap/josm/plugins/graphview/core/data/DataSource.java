...
public interface DataSource<N, W, R, M> {
    ...
    /**
     * adds an observer. Does nothing if the parameter is already an observer of
     * this DataSource.
     *
     ...
     * {@link #addObserver(DataSourceObserver)}. Does nothing if the parameter
     * isn't currently an observer of this DataSource.
     *
     * @param observer observer object, != null
     */
