...
public class RecentFilesUpdater implements PreferenceChangeListener {
    ...
    /**
     * creates the updater, registers it as a listener and builds the initial
     * content of the menu
     *
     * @param actionForFile function creating the listener for opening a
     * particular file
     */
    ...
    /**
     * builds (or rebuilds) the menu items in the {@link #recentFilesMenu} based
     * on the current state of the preferences
     */
    ...
    /**
     * returns the list of recent files from user preferences. The list is
     * sorted from newest to oldest entry.
     */
    ...
    /**
     * adds a file to the persistently stored list of recent files. May replace
     * an existing entry if maximum capacity is reached.
     */
