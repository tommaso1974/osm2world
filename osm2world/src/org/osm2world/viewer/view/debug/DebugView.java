...
public abstract class DebugView {
    ...
    /**
     * returns true if this DebugView can currently be used for rendering. By
     * default, this checks whether all the setters have been used with non-null
     * values, but subclasses can overwrite it with their own checks.
     */
    ...
    /**
     * renders the content added by {@link #fillTarget(JOGLTarget)}. Only has an
     * effect if {@link #canBeUsed()} is true.
     *
    ...
    /**
     * lets the subclass add all content and settings for rendering. Will only
     * be called if {@link #canBeUsed()} is true.
     */
