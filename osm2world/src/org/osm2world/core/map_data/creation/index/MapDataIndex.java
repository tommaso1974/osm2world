...
/**
 * index structure intended to speed up retrieval of candidates for intersection
 * and overlap tests
 */
public interface MapDataIndex {
    ...
    /**
     * inserts the element into the index structure, and returns all nearby
     * elements contained the index structure
     *
