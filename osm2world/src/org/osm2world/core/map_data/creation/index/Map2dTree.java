...
/**
 * a 2D tree (two-dimensional k-d tree) managing {@link MapElement}s of a data
 * set according on their coordinates in the XZ plane.
 *
 * Data is contained within the leafs. The inner nodes split the XZ plane along
 * parallels to the Z and X axes, alternatingly.
 */
