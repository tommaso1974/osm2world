...
/**
 * function that converts latitude/longitude coordinates to internally used x/z
 * coordinates
 */
public interface MapProjection {
    ...
    /**
     * returns a vector that points one meter to the north from the position
     * that becomes the coordinate origin
     */
