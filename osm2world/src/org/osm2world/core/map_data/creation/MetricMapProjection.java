...
/**
 * Map projection that is intended to use the "dense" space of floating point
 * values by making all coordinates relative to the origin. 1 meter distance is
 * roughly represented by 1 internal unit.
 */
