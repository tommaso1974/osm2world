...
public class EmptyTerrainBuilder {
    ...
    /**
     * creates a grid of square {@link MapArea}s to represent empty terrain. The
     * areas are connected with each other, but do not overlap, and cover the
     * entire data bounds.
     *
     * These areas do not come from OSM data, but they are treated the same as
     * mapped areas later on to avoid unnecessary special case handling.
     */
