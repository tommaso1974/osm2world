...
public class ConversionFacade {
    ...
    public static final class Results {
         ...
         * renderableType, including terrain. Convenience method.
         */
    ...
    private static final List<WorldModule> createDefaultModuleList() {
        ...
        return Arrays.asList((WorldModule) new RoadModule(),
                new RailwayModule(),
                new BuildingModule(),
                new ParkingModule(),
                new TreeModule(),
    ...
    /**
     * sets the factory that will make {@link TerrainInterpolator} instances
     * during subsequent calls to
     * {@link #createRepresentations(OSMData, List, Configuration, List)}.
     *
     * @see DefaultFactory
     ...
     * @param worldModules modules that will create the {@link WorldObject}s in
     * the result; null to use a default module list
    ...
    /**
     * variant of
     * {@link #createRepresentations(File, List, Configuration, List)} that
     * accepts {@link OSMData} instead of a file. Use this when all data is
     * already in memory, for example with editor applications.
     *
...
//	}
    /**
     * exception to be thrown if the OSM input data covers an area larger than
     * the maxBoundingBoxDegrees config property
     */
