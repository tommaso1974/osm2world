...
public class VectorXYZ implements Vector3D, IntersectionTestObject {
    ...
    /**
     * returns the result of rotating this vector around the given normalized
     * vector n
     *
     * @param angleRad angle in radians
    ...
    /**
     * calculates the angle between this vector and other, but only if both are
     * normalized!
     */
    ...
    /**
     * creates a VectorXYZ for any Vector3D object. If the Vector3D is already a
     * VectorXYZ, this can return the original vector.
     */
