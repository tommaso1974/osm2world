...
public class VectorXZ implements Vector3D {
    ...
    /**
     * returns the vector that would result from calculating the cross product
     * of this vector (normalized and extended to three dimensions) and (0,1,0).
     *
     * It's the vector that, seen from "above", points to the right side of this
    ...
    /**
     * gets this vector's angle relative to (0,1). Inverse of
     * {@link #fromAngle(double)}.
     *
