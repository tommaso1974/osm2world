...
/**
 * utility class for Constructive Area Geometry (CAG), boolean operations on
 * areas
 */
public final class CAGUtil {
    ...
    /**
     * takes a polygon outline, "subtracts" a collection of other polygon
     * outlines, and returns a collection of polygons that covers the difference
     * area.
     *
     * The result polygons should cover the area that was within the original
     * polygon (excluding its holes), but not within a subtracted polygon.
     *
