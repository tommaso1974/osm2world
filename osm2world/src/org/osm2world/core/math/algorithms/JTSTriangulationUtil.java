...
/**
 * uses the JTS library for triangulation. Creates a Conforming Delaunay
...
public final class JTSTriangulationUtil {
    ...
    /**
     * triangulation of a polygon with holes, based on a conforming delaunay
     * triangulation
     */
    ...
    /**
     * variant of {@link #triangulate(SimplePolygonXZ, Collection)} that accepts
     * some unconnected points within the polygon area and will try to create
     * triangle vertices at these points. It will also accept line segment as
