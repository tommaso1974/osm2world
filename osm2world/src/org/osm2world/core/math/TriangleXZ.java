...
public class TriangleXZ {
    ...
    /**
     * returns this triangle if it is counterclockwise, or the reversed triangle
     * if it is clockwise.
     */
    ...
    /**
     * returns this triangle if it is clockwise, or the reversed triangle if it
     * is counterclockwise.
     */
    ...
    /**
     * returns an inversed version of this triangle. It consists of the same
     * vertices, but has the other direction.
     */
