...
/**
 * exception that is used when attempting to construct geometry that does not
 * exhibit required properties - such as self-intersecting polygons. In cases
 * where these exceptions can be caused by problems in the data, it makes sense
