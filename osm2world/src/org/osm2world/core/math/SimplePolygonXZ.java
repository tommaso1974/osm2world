...
public class SimplePolygonXZ extends PolygonXZ {
    ...
    /**
     * @return a {@link PolygonWithHolesXZ} with this polygon as the outer
     * polygon and no holes
     */
    ...
    /**
     * returns this polygon if it is counterclockwise, or the reversed polygon
     * if it is clockwise.
     */
    ...
    /**
     * returns this polygon if it is clockwise, or the reversed polygon if it is
     * counterclockwise.
     */
    ...
    /**
     * returns the distance of a point to the segments this polygon. Note that
     * the distance can be > 0 even if the polygon contains the point
     */
    ...
    /**
     * returns a different polygon that is constructed from this polygon by
     * removing all vertices where this has an angle close to 180° (i.e. where
     * removing the vertex does not change the polygon very much).
     */
    ...
    /**
     * calculates the area of a planar non-self-intersecting polygon. The result
     * is negative if the polygon is clockwise.
     */
