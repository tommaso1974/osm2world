...
public final class MinMaxUtil {
    ...
    /**
     * from an Iterable of objects, this returns the one with the lowest
     * associated value of a function f
     *
     * @return any of the inputs that generate the minimum function value, null
     * if objects is empty
     */
    ...
    /**
     * from an Iterable of objects, this returns the one with the highest
     * associated value of a function f
     *
     * @return any of the inputs that generate the maximum function value, null
     * if objects is empty
     */
