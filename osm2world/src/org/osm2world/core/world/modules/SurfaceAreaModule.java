...
/**
 * adds generic areas with surface information to the world. Is based on surface
 * information on otherwise unknown/unspecified areas.
 */
public class SurfaceAreaModule extends AbstractModule {
    ...
    private static class SurfaceArea extends AbstractAreaWorldObject
        ...
        /**
         * calculates the true ground footprint of this area by removing area
         * covered by other overlapping features, then triangulates it into
