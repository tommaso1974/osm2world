 ...
 *
 * Needs to be applied <em>after</em> all the modules that generate whatever
        ...
        if (node.getConnectedWaySegments().size() == 2) {
            ...
            if (isTunnel(segmentA) && !isTunnel(segmentB)
                ...
                node.addRepresentation(new TunnelEntrance(node,
                        (AbstractNetworkWaySegmentWorldObject) segmentA.getPrimaryRepresentation()));
                ...
                node.addRepresentation(new TunnelEntrance(node,
                        (AbstractNetworkWaySegmentWorldObject) segmentB.getPrimaryRepresentation()));
...
//						primaryRep.getClearingAbove(leftOutline.get(i).xz()));
    ...
    public static class TunnelEntrance implements NodeWorldObject,
        ...
        /**
         * counterclockwise outline composed of null null         {@link #lowerLeft}, {@link #lowerCenter}, {@link #lowerRight},
