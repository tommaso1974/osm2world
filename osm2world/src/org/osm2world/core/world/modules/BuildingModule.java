...
//		}
    ...
    public static class BuildingPart implements RenderableToAllTargets {
            ...
            if (area.getOverlaps().isEmpty()) {
                ...
                for (MapOverlap<?, ?> overlap : area.getOverlaps()) {
                    ...
                    if (other.getPrimaryRepresentation() instanceof TerrainBoundaryWorldObject
                        ...
                        tbWorldObjects.add((TerrainBoundaryWorldObject) other.getPrimaryRepresentation());
                    }
                }
        ...
        /**
         * sets the building part attributes (height, colors) depending on the
         * building's and building part's tags. If available, explicitly tagged
         * data is used, with tags of the building part overriding building
         * tags. Otherwise, the values depend on indirect assumptions (level
         * height) or ultimately the building class as determined by the
         * "building" key.
         */
        ...
        public static interface Roof extends RenderableToAllTargets {
            ...
            /**
             * returns the outline (with holes) of the roof. The shape will be
             * generally identical to that of the building itself, but
             * additional vertices might have been inserted into segments.
             */
        ...
        /**
         * superclass for roofs based on roof:type tags. Contains common
         * functionality, such as roof height parsing.
         */
        ...
        /**
         * superclass for roofs that have exactly one height value for each
         * point within their XZ polygon
         */
        public abstract class HeightfieldRoof extends TaggedRoof {

            /**
             * returns segments within the roof polygon that define ridges or
             * edges of the roof
             */
            public abstract Collection<LineSegmentXZ> getInnerSegments();

            /**
             * returns segments within the roof polygon that define apex nodes
             * of the roof
             */
            public abstract Collection<VectorXZ> getInnerPoints();

            /**
             * returns roof elevation at a position. Only required to work for
             * positions that are part of the polygon, segments or points for
             * the roof.
             *
...
//								getInnerPoints());
        ...
        /**
         * tagged roof with a ridge. Deals with ridge calculation for various
         * subclasses.
         */
        abstract private class RoofWithRidge extends HeightfieldRoof {
             ...
             *
             * @param relativeRoofOffset distance of ridge to outline relative
             * to length of roof cap; 0 if ridge ends at outline
             */
    ...
    private static class BuildingEntrance implements NodeWorldObject,
        ...
        public GroundState getGroundState() {
            ...
            for (MapWaySegment waySegment : node.getConnectedWaySegments()) {
                ...
                if (waySegment.getPrimaryRepresentation() instanceof AbstractNetworkWaySegmentWorldObject) {
