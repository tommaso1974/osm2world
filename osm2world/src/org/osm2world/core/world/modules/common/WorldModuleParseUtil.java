...
/**
 * utility class that can be used by {@link WorldModule}s to interpret
 * frequently used value formats.
 */
public class WorldModuleParseUtil {
    ...
    /**
     * returns the value of the first key that exists, or the fallback value if
     * none of the keys exists
     */
    ...
    /**
     * retrieves width using (in this priority order) width tag, est_width tag,
    ...
    /**
     * retrieves height using (in this priority order) height tag,
     * building:height tag, est_height tag, defaultValue parameter
     */
    ...
    /**
     * retrieves clearing using (in this priority order) practical:maxheight
     * tag, maxheight tag, defaultValue parameter
     */
    ...
    /**
     * parses the direction tag and returns the direction (or a default value)
     * as radians
     */
