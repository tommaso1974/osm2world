...
public final class WorldModuleGeometryUtil {
    ...
    /**
     * creates the vectors for a vertical triangle strip at a given elevation
     * above a line of points
     */
    ...
    /**
     * creates a triangle strip between two outlines with identical number of
     * vectors
     */
    ...
    /**
     * creates triangle strip vectors for a shape extruded along a line of
     * coordinates
     *
     * @param shape shape relative to origin
     * @param extrusionPath nodes to extrude the shape along; needs at least 2
     * nodes
     * @param upVectors vector for "up" direction at each extrusion path node.
     * You can use {@link Collections#nCopies(int, Object)} if you want the same
     * up vector for all nodes.
    ...
    /**
     * creates an rotated version of a list of vectors by rotating them by the
     * given angle around the parallel of the x axis defined by the given Y and
     * Z coordinates
     *
    ...
    /**
     * moves a shape that was defined at the origin to a new position. This is
     * used by {@link #createShapeExtrusionAlong(List, List, List)}
     *
     ...
     *
     * This can be used to avoid placing trees, bridge pillars and other
     * randomly distributed features on roads, rails or other similar places
