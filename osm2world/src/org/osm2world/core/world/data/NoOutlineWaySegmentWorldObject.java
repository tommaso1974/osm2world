...
/**
 * superclass for {@link WaySegmentWorldObject}s that don't have an outline, and
 * are not part of a network. Instead, they can be considered infinitely thin.
 */
public abstract class NoOutlineWaySegmentWorldObject
    ...
    /**
     * returns the 3d start position. Only available after elevation
     * calculation.
     */
    ...
    /**
     * returns the 3d end position. Only available after elevation calculation.
     */
    ...
    /**
     * returns the 3d vertex sequence running along the segment. Only available
