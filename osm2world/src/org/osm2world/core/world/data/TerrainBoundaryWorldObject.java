...
/**
 * area covered by representations with this interface will not be covered by
 * terrain if the representation is on the ground (according to
 * {@link WorldObject#getGroundState()}).
 */
