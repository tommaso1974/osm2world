...
/**
 * world object that has a defined outline that can be used for purposes such as
 * cutting holes into the terrain (if this is instance of
...
public interface WorldObjectWithOutline extends WorldObject {
    ...
    /**
     * returns a counterclockwise polygon defining the object's ground
     * footprint.
     *
    ...
    /**
     * returns a counterclockwise polygon defining the object's ground
     * footprint, projected onto the XZ plane.
     *
     * @return outline polygon; null if this world object doesn't cover any area
     */
