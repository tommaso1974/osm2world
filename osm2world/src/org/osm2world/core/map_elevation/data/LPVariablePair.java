...
/**
 * a pair of variables for a linear program, representing the elevation of a set
 * of {@link EleConnector}s.
 */
public class LPVariablePair {
    ...
    /**
     * creates a variable pair for a first {@link EleConnector}. Others may be
     * added later.
     */
    ...
    /**
     * returns all connectors currently in this set. Must return the same object
     * over the lifetime of this {@link LPVariablePair} instance.
     */
    ...
    /**
     * adds a connector to the set of {@link EleConnector}s whose elevation is
     * represented by this {@link LPVariablePair}
     */
