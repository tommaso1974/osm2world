...
public final class SimpleEleConstraintEnforcer implements EleConstraintEnforcer {
    ...
    /**
     * associates each EleConnector with the {@link StiffConnectorSet} it is
     * part of (if any)
     */
    ...
    /**
     * a set of connectors that are required to have the same elevation TODO or
     * a precise vertical offset
     */
