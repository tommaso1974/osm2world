...
/**
 * uses least squares method to approximate a polynomial at each site, and
 * calculates elevations based on the polynomials at the nearest sites.
 */
public class LeastSquaresInterpolator implements TerrainInterpolator {
    ...
    /**
     * provides access to the polynomials approximated internally. This is
     * usually only interesting for debugging or similar tasks.
     */
                    ...
                    if (i == cellX - cellRange || i == cellX + cellRange
                        ...
                        if (sitesInCell != null) {
                            for (SiteWithPolynomial site : sitesInCell) {
                                ...
                                if (requirePolynomial && site.polynomial == null) {
                                    continue;
                                }
