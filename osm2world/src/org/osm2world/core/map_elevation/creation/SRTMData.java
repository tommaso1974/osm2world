...
public class SRTMData implements TerrainElevationData {
    ...
    /**
     * variant of getSites which calculates minimum and maximum lat/lon from the
     * bounds of a {@link MapData} instance
     *
     * TODO: make projection reversible, then replace both getSites methods with
     * a single getSite(AxisAlignedBoundingBox dataBounds) method
     */
    @Override
