...
public interface EleConstraintEnforcer {
    ...
    /**
     * requires a connector to be a give distance above a line segment defined
     * by two other connectors.
     *
     ...
     *
     * @param incline incline value, negative values are inclines in opposite
     * direction
     */
    ...
    /**
     * tries to enforce the previously added constraints on elevations of
     * connectors that have been added using {@link #addConnectors(Iterable)}
     */
