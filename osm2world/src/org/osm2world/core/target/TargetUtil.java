...
public final class TargetUtil {
    ...
    /**
     * render all world objects to a target instances that are compatible with
     * that target type. World objects are added to a target until the number of
     * primitives reaches the primitive threshold, then the next target is
