...
//	}
    /**
     * provides direct write access to the generated source code. This is
     * intended for Renderables using special POVRay features.
     */
...
//	}
    ...
    /**
     * variant of
     * {@link #drawColumn(Material, Integer, VectorXYZ, double, double, double, boolean, boolean)}
    ...
    /**
     * adds a vector to the String built by a StringBuilder. Syntax is "<x, y,
     * z>".
     */
    ...
    /**
     * alternative to {@link #appendVector(double, double)} using a vector
     * object as parameter instead of individual coordinates
     */
    ...
    /**
     * adds a vector to the String built by a StringBuilder. Syntax is "<v1,
     * v2>".
     */
