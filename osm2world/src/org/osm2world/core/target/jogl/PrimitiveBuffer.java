...
/**
 * Storage for low-level rendering information (vertex and primitive data) that
 * can be displayed using graphics APIs, e.g. OpenGL. Higher-level information,
 * such as object coherence, OSM attributes or representations, isn't present in
 * a PrimitiveBuffer.
 */
