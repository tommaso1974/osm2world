...
/**
 * renders the contents of a {@link PrimitiveBuffer} using JOGL. Uses vertex
 * buffer objects (VBO) to speed up the process.
 *
...
public class JOGLRendererVBO extends JOGLRenderer {
    ...
    private abstract class VBOData<BufferT extends Buffer> {
        ...
        /**
         * returns the number of vertices required to represent a collection of
         * primitives with individual triangles
         */
        ...
        private void addPrimitiveToValueBuffer(BufferT buffer,
            ...
            for (int i = 0; i < primVertices.size(); i++) {
                ...
                assert (primTexCoordLists == null
                        ...
                        && primTexCoordLists.size() == material.getNumTextureLayers()) : "WorldModules need to provide the correct number of tex coords";
