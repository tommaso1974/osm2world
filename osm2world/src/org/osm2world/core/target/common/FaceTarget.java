...
/**
 * a target that relies on faces to represent geometry. The faces used by this
 * target are polygons with three or more coplanar vertices.
 *
...
public abstract class FaceTarget<R extends Renderable>
    ...
    /**
     * decides whether faces should be reconstructed from triangulations and
     * other primitives.
     */
     ...
     *
     * This is automatically done at the beginning of each new object. It only
     * has any effect if {@link #reconstructFaces()} is enabled.
     *
    ...
    /**
     * integrates all {@link #isolatedTriangles} into faces, then draws all
     * faces and clears the collection.
     */
