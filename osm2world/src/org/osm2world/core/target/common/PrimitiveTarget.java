...
/**
 * superclass for targets that are based on OpenGL primitives. These targets
 * will treat different primitives similarly: They convert them all to a list of
 * vertices and represent the primitive type using an enum or flags.
 */
public abstract class PrimitiveTarget<R extends Renderable>
     ...
     * @param texCoordLists texture coordinates for each texture layer, each
     * list has the same size as vs
     */
