...
public final class Materials {
    ...
    /**
     * returns a human-readable, unique name for a material defined within this
     * class, null for all other materials.
     */
    ...
    /**
     * configures the attributes of the materials within this class based on
                ...
                if (material != null) {
                    ...
                    if ("color".equals(attribute)) {
                        ...
                        for (int i = 0; i < 32; i++) {
                            ...
                            if (config.getString(fileKey) == null) {
                                break;
                            }
