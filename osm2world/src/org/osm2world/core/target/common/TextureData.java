...
/**
 * a texture with all information necessary for applying it to an object that
...
public class TextureData {
    ...
    /**
     * whether the texture is modulated with the material color. Otherwise, a
     * plain white base color is used, resulting in the texture's colors
     * appearing unaltered (except for lighting)
     */
