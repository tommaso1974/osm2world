...
public class Camera {
    ...
    /**
     * returns the vector that is orthogonal to the connection between pos and
     * lookAt and points to the right of it. The result has length 1.
     */
    ...
    /**
     * moves lookAt to represent a rotation counterclockwise around the y axis
     * on pos
     *
    ...
    /**
     * rotates the camera around an axis orthogonal to the y axis and
     * {@link #getViewDirection()}. The effect is similar to
     * {@link #pitch(double)}, but independent from the current roll angle.
     *
     * @param d angle in radians
     */
