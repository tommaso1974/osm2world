...
/**
 * configuration of the projection from 3D world to screen (<em>not</em> the map
 * projection)
 */
public class Projection {
    ...
    /**
     * vertical viewing volume angle; only relevant for <em>perspective</em>
     * projection
     */
    private final double vertAngle;

    /**
     * height of the viewing volume; only relevant for <em>orthographic</em>
     * projection
     */
