...
public final class TestUtil {
    ...
    /**
     * returns VectorXZ objects; can be used to test properties that need to be
     * true for all vectors.
     *
     * Will contain some fixed common vectors and a lot of random vectors (that
     * will be the same every time, though, so tests can be reproduced).
     */
